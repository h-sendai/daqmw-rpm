Name:           kek-daqmiddleware-testing2-repo       
Version:        8 
Release:        0%{?dist}
...
Source0:        kek-daqmiddleware-testing2.repo	
...
%description
This package contains the KEK DAQ Middleware TESTING2 repostiry configuration file.
