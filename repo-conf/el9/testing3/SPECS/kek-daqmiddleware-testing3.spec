Name:           kek-daqmiddleware-testing3-repo       
Version:        9 
Release:        0%{?dist}
...
Source0:        kek-daqmiddleware-testing3.repo	
...
%description
This package contains the KEK DAQ Middleware TESTING3 repostiry configuration file.
